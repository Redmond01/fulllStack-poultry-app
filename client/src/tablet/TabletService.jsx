...
const TabletService = () => {
    ...
    return (
        <div className='lg:hidden md:block sm:hidden selection:bg-brown'>
            ...
            <div className='w-full h-[222svh] absolute top-0'>
                <div className='w-full h-[8svh] bg-whites absolute top-[0%] flex'>
                    ...
                    <div className='w-[40%] h-full'>
                        <div className='w-full h-full flex'>
                            <div className='w-full h-full '>
                                <h3 className='text-[calc(1px_+_.5svw_+_.5svh)] capitalize font-default font-[500]  '>“About Our Poultry Farm Service”</h3>
                                <h3 className='text-[calc(1px_+_1.7svw_+_1.7svh)] capitalize font-default font-[500] leading-[100%]'>Best Poultry
                                    Farm Services</h3>
                                <br />
                                <h3 className='w-[70%] text-slate-500 text-[calc(.8px_+_.6svw_+_.6svh)] capitalize font-default font-[400] leading-[100%]'>Amet minim mollit non deserunt ullamco est sit aliqua
                ...
                <div className='w-full h-[155svh] bg-whites'>
                    <div className='w-full h-[20svh] flex'>
                        ...
                        <div className='w-[70%] h-full flex'>
                            <div className='w-[25%] h-full flex flex-col justify-center items-center leading-[400%] '>
                                <h3 className='text-[calc(1px_+_2.8svw_+_2.8svh)] font-default font-[700] text-brown capitalize'>30k</h3>
                                <h3 className='text-[calc(1px_+_.5svw_+_.5svh)] font-default font-[500] capitalize'>happy customers</h3>
                            </div>
                            <div className='w-[25%] h-full flex flex-col justify-center items-center leading-[400%] '>
                                <h3 className='text-[calc(1px_+_2.8svw_+_2.8svh)] font-default font-[700] text-brown capitalize'>75k</h3>
                                <h3 className='text-[calc(1px_+_.5svw_+_.5svh)] font-default font-[500] capitalize'>monthly visitors</h3>
                            </div>
                            <div className='w-[25%] h-full flex flex-col justify-center items-center leading-[400%] '>
                                <h3 className='text-[calc(1px_+_2.8svw_+_2.8svh)] font-default font-[700] text-brown capitalize'>12k</h3>
                                <h3 className='text-[calc(1px_+_.5svw_+_.5svh)] font-default font-[500] capitalize'>customers reviews</h3>
                            </div>
                            <div className='w-[25%] h-full flex flex-col justify-center items-center leading-[400%] '>
                                <h3 className='text-[calc(1px_+_2.8svw_+_2.8svh)] font-default font-[700] text-brown capitalize'>4k</h3>
                                <h3 className='text-[calc(1px_+_.5svw_+_.5svh)] font-default font-[500] capitalize'>services rendered</h3>
                            </div>
                        </div>
                        <div className='w-[15%] h-full'></div>
                    </div>
                        ...
                        <div className='w-[80%] h-full flex'>
                            <div className='w-[50%] h-full flex flex-col'>
                                ...
                                <div className='w-full h-[30%]'>
                                    <h3 className='text-[calc(1px_+_2svw_+_2svh)] capitalize font-default font-[500] leading-[120%]'>Services <br />
                                        Fragrant Farm</h3>
                                </div>
                                <div className='w-full h-[20%]'>
                                    <h3 className='w-[70%] text-slate-500 text-[calc(1px_+_.5svw_+_.5svh)] capitalize font-default font-[500] leading-[200%]'>Amet minim mollit non deserunt ullamco est sit aliqua
                            ...
                            <div className='w-[50%] h-full flex justify-center items-center'>
                                <div className='w-[90%] h-[90%] rounded-xl shadow-lg transition-all duration-[.5s]'>
                                    <div className='w-full h-[15%]'></div>
                                    <div className='w-full h-[60%] flex flex-col justify-center items-center'>
                                        <div>
                                            <FaServicestack className='text-[calc(1px_+_1.8vw_+_1.8svh)] fill-brown hover:text-[calc(.8px_+_2.2vw_+_2.2svh)] hover:cursor-pointer transition-all duration-[.5s]' />
                                        </div>
                                        <h3 className='text-black text-[calc(1px_+_1.5svw_+_1.5svh)]  capitalize font-default font-[500]'>This is the heading</h3>
                                        <h3 className='w-[70%] text-slate-500 text-[calc(1px_+_.5vw_+_.5svh)] capitalize font-default font-[500] leading-[100%]'>Amet minim mollit non deserunt ullamco est sit aliqua
                                            dolor do amet sint Veli.</h3>
                                    </div>
                            ...
                            <div className='w-[50%] h-full flex justify-center items-center'>
                                <div className='w-[90%] h-[90%] rounded-xl shadow-lg hover:shadow-2xl transition-all duration-[.5s]'>
                                    ...
                                    <div className='w-full h-[60%] flex flex-col justify-center items-center'>
                                        ...
                                        <h3 className='text-black text-[calc(1px_+_1.5svw_+_1.5svh)] capitalize font-default font-[500]'>This is the heading</h3>
                                        <h3 className='w-[70%] text-slate-500 text-[calc(1px_+_.5vw_+_.5svh)] capitalize font-default font-[500] leading-[200%]'>Amet minim mollit non deserunt ullamco est sit aliqua
                                            dolor do amet sint Veli.</h3>
                                    </div>
                                    <div className='w-full h-[15%]'></div>
                                </div>
                    ...
                    <div className='w-full h-[30svh] flex justify-center items-center'>
